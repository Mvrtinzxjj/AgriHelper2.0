...
const city = 'Madrid'; // Puedes cambiar la ciudad a la que deseas obtener el clima
...
// Inicializar el mapa
const map = L.map(mapElement).setView([40.4168, -3.7038], 13); // Coordenadas de Madrid
...
// Agregar marcador en el mapa (Madrid)
